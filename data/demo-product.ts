...
export const DEMO_PRODUCT: DemoProduct = {
  ...
  images: [adaptis, adaptis__1],
  colorOptions: [
    { label: "Natural Boucle", hex: "#D4C4A8" },
  ...
  policy: {
    shipping: `Our preferred partners for shipments are GLS and NGT/LGT. GLS for package deliveries and NGT/LGT for furniture and larger items.\n\nWe process your order as quickly as possible. Orders on stocked items are handled and fulfilled at our warehouse in Chittagong with expected shipping of 2–5 business days depending on location. Larger products, made-to-order and pre-orders will ship according to the estimated ship date stated on the product page.\n\nWe offer free shipping on orders over ৳ 10,000.`,
